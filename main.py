...
class Teacher:
    def __init__(self, first_name, last_name, age, email, can_teach_subjects):
        ...
        self.assigned_subjects = set()  # предмети, які призначено цьому викладачу
...
def create_schedule(subjects, teachers):
    ...
    while remaining_subjects:
        # Вибираємо викладача, який покриває найбільше ще не охоплених предметів
        best_teacher = None
        best_coverage = set()
        ...
        # Якщо ніхто не може покрити залишені предмети
        if not best_teacher or not best_coverage:
            return None

        # Призначаємо викладачу його предмети
